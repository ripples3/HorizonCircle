...
/**
 * @title LendingModuleCorrectFunctions
 * @notice Uses correct Morpho functions: supplyCollateral() and borrow()
 */
contract LendingModuleCorrectFunctions {
    // Constants
    ...
    IMorphoCorrect public immutable morpho;
    ...
    constructor() {
        ...
        morpho = IMorphoCorrect(MORPHO_ADDRESS);
        owner = msg.sender;
    }
    ...
    function supplyCollateralAndBorrow(
        ...
        // Supply wstETH as collateral - CORRECT FUNCTION!
        ...
        // Borrow WETH against collateral - CORRECT FUNCTION!
        morpho.borrow(
            MORPHO_MARKET_ID,
            wethToBorrow,
