...
/**
 * @title LendingModule
 * @notice Handles Morpho lending market operations
 * @dev Isolated module for wstETH collateral supply and WETH borrowing
 */
contract LendingModule {
    ...
    // Morpho market ID for wstETH/WETH
    bytes32 constant MORPHO_MARKET_ID = 0xd1cf8c315f54e808c89be488b51ad2a6949bc8a5f83f62d30e0ab0290e3260f0;
    ...
    function supplyCollateralAndBorrow(
        ...
        morpho.supply(
            ...
            msg.sender, // On behalf of the circle
            ""
        );
