...
/**
 * @title LendingModuleMorphoBlue
 * @notice Correct Morpho Blue interface using MarketParams struct
 */
contract LendingModuleMorphoBlue {
    // Constants
    ...
    function supplyCollateralAndBorrow(
        ...
        // Supply wstETH as collateral using MarketParams struct - CORRECT INTERFACE!
        ...
        // Borrow WETH against collateral using MarketParams struct - CORRECT INTERFACE!
