...
contract DeployUniversalRouterV2Factory is Script {
    ...
    function run() external {
        ...
        console.log("=== Deploying UNIVERSAL ROUTER V2 FACTORY ===");
        console.log("Deployer:", vm.addr(deployerPrivateKey));
        console.log("Registry:", REGISTRY);
        console.log("Implementation:", UNIVERSAL_ROUTER_V2_IMPLEMENTATION);

        // Deploy factory with Universal Router V2 implementation
        ...
        console.log("\n=== UNIVERSAL ROUTER V2 FACTORY DEPLOYMENT COMPLETE ===");
        console.log("REGISTRY:", REGISTRY);
        console.log("FACTORY:", address(factory));
        console.log("IMPLEMENTATION:", UNIVERSAL_ROUTER_V2_IMPLEMENTATION);
        console.log("STATUS: Ready for final testing - Universal Router with V2 factory should resolve validation issue");
    }
}