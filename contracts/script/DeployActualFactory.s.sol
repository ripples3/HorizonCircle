...
contract DeployActualFactory is Script {
    function run() external {
        vm.startBroadcast();
        
        address implementation = 0x5b73C5498c1E3b4dbA84de0F1833c4a029d90519; // Fixed core
        SimpleFactory factory = new SimpleFactory(implementation);
        
        console.log("Actual factory deployed:", address(factory));
